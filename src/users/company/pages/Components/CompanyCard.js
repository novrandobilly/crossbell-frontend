...
const CompanyCard = props => {
	return (
		<React.Fragment>
			...
			<TextOnly id={props.companyId} labelName='Company Detail' route='details' text={props.details} />

			<TextOnly id={props.companyId} labelName='Company Mission' route='mission' text={props.mission} />
		</React.Fragment>
	);
};
