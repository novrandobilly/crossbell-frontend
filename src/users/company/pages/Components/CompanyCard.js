			...
			<div className={classes.Wraper}>
				...
				<div className={classes.Content}>
					...
					<div className={classes.CardContainer}>
						...
						{!props.isLoading &&
						props.auth.isCompany &&
						props.auth.userId === companyid && <div className={classes.BorderLine}>Belum ditayangkan</div>}
						...
						{!props.isLoading &&
						props.auth.isCompany &&
						props.auth.userId === companyid && <div className={classes.BorderLine}>Sedang ditayangkan</div>}
						...
						{!props.isLoading &&
						props.auth.isCompany &&
						props.auth.userId === companyid && <div className={classes.BorderLine}>Sudah lewat masa tayang</div>}
