					...
					<div className={classes.Content}>
						...
						<div className={classes.ContentTop}>
							...
							<div className={classes.ContentRight}>
								...
								<FormControl className={classes.formControl} style={{ width: '100%', marginTop: '1.2rem' }}>
									<InputLabel shrink id='interest'>
										Bidang minat 3
									</InputLabel>
						...
						<div className={classes.ContentBottom}>
							...
							<label onChange={onCheckedInputHandler}>
								<input id='autoSend' type='checkbox' name='autoSend' /> Saya bersedia didaftarkan kerja secara otomatis oleh
								Crossbell
							</label>
							<label onChange={onCheckedInputHandler}>
