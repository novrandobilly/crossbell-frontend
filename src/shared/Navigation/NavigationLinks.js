			...
			<ul className={classes.NavLinks}>
				...
				props.admin.isLoggedIn && (
					<React.Fragment>
						...
						<li>
							<div className={classes.dropdown}>
								<button className={classes.dropbtn} onClick={DropdownOrderAdmin} ref={ref}>
									Order & Finance
									<ArrowDropDownIcon style={{ alignSelf: 'center', marginBottom: '-0.4rem' }} />
								</button>

								<div className={adminDropdown ? classes.dropdownShow : classes.dropdownContent} id='dropdownCompany'>
									<NavLink to={`/ad/alphaomega/promo`} activeClassName={classes.active}>
										<p>Update Promo</p>
									</NavLink>
									<NavLink to={`/ad/alphaomega/order/reguler`} activeClassName={classes.active}>
										<p>Order Reguler List</p>
									</NavLink>
									<NavLink to={`/ad/alphaomega/order/candidate`} activeClassName={classes.active}>
										<p>Order Bulk Candidate List</p>
									</NavLink>
									<NavLink to={`/ad/alphaomega/order/es`} activeClassName={classes.active}>
