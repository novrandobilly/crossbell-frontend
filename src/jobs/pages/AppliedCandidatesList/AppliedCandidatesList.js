...
import classes from './AppliedCandidatesList.module.css';
            ...
            <div className={classes.CardContainer} key={dat.id}>
              <div className={classes.CardLeft}>
                <div
                  ...
                  style={{
                    backgroundImage: `url('${dat.picture ? dat.picture.url : <BlankProfile />}')`,
                  }}
                />
              </div>
              ...
              <div className={classes.CardMid}>
                ...
                <div className={classes.CardMidTitle}>
                  ...
                  {dat.experience.length > 0 ? dat.experience[0].prevTitle : ' - '}
                </div>
                <div className={classes.CardMidLocation}>
                  <span>at</span> {dat.experience.length > 0 ? dat.experience[0].prevCompany : ' - '}
                </div>
                ...
                <div className={classes.CardMidLocation}>
                  <span>at</span> {dat.education.length > 0 ? dat.education[0].school : ' - '}
                </div>
                <div className={classes.CardMidTitle}>GPA: {dat.education.length > 0 ? dat.education[0].IPK : ' - '}</div>
              ...
              <div className={classes.CardRight}>
                ...
                <div className={classes.ExtraDetails}>
                  ...
                  <p className={classes.GenderAge}>
                    {!dat.gender ? ' - ' : dat.gender === 'male' ? 'Pria' : 'Wanita'},{' '}
                    {dat.dateOfBirth ? moment().diff(moment(dat.dateOfBirth), 'year') : '0'} tahun
                  </p>{' '}
                </div>

                <div className={classes.ExtraDetails}>
                  <MonetizationOnOutlinedIcon fontSize='small' style={{ marginRight: '6px' }} />
                  <p className={classes.Salary}>Harapan gaji: Rp. {dat.salary ? dat.salary.toLocaleString() : '0'}</p>
                </div>
                ...
                <div className={classes.ExtraDetails}>
                  ...
                  <p className={classes.Phone}>{dat.phone ? dat.phone : ' - '}</p>
                </div>
              </div>
            </div>
          );
