...
const JobDetails = (props) => {
  ...
  const jobCompany = props.companies.find(
    (co) => co.companyId === props.companyId
  );
            ...
            <div className={classes.ContainerThird}>
              ...
              <div className={classes.ButtonContainer}>
                ...
                <button
                  ...
                  className={[classes.InstantButton, classes.DeleteButton].join(
                    " "
                  )}
                >
                  <span>Delete</span>
...
const mapDispatchToProps = (dispatch) => {
  return {
    deleteJob: (jobId) =>
      dispatch({ type: actionTypes.DELETEJOB, payload: { jobId } }),
  };
};
